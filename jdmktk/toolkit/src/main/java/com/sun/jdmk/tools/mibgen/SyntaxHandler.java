...
public class SyntaxHandler extends SymbolHandler {
  ...
  public SyntaxHandler(String mibModule) {
    super(mibModule);
  }
   ...
   */
  public void resolveTypeRef(ASTTypeReference node) {
    ...
    if (resolver!= null) {
      ...
      addNewUnresolvedSyntax(name, node);
    }
  }
  ...
  // PRIVATE METHODS
  //----------------
  private void addNewUnresolvedSyntax(String name, ASTTypeReference node) {
    ...
    //Trace.info("Add unresolved syntax symbol: " + name);
  }  

  /**
   * Version of the implementation
   */
   private static final String sccs_id = "@(#)SyntaxHandler.java 4.8 03/08/07 SMI";
