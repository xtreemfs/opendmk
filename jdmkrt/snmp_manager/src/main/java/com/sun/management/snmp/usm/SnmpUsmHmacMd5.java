...
/**
 * Provides the parameters needed by <CODE>SnmpUsmHmacAlgorithm</CODE> to instantiate an Hmac MD5 algorithm.
 *
 * @since Java DMK 5.1
 */
public class SnmpUsmHmacMd5 extends SnmpUsmHmacAlgorithm {
     ...
     * @return The oid 1.3.6.1.6.3.10.1.1.2
     */
