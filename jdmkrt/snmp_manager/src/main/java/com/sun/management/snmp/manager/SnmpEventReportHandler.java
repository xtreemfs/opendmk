/*
 * @(#)file      SnmpEventReportHandler.java
...
class SnmpEventReportHandler implements Runnable {
    ...
    public SnmpEventReportHandler(SnmpTrapListener l, SnmpPdu p) {
        trapListener = l;
        pdu = p;
    }
    
    public SnmpEventReportHandler(SnmpInformListener l, SnmpPdu p) {
        informListener = l;
        pdu = p;
    }
