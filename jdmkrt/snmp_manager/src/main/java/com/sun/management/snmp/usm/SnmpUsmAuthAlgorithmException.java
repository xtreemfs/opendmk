/*
 * @(#)file      SnmpUsmAuthAlgorithmException.java
...
public class SnmpUsmAuthAlgorithmException extends SnmpUsmException {
    private static final long serialVersionUID = -8633606335431603082L;
    /**
     * Constructor. The passed message is used when displaying the exception.
     * @param msg The exception message.
     */
    public SnmpUsmAuthAlgorithmException(String msg) { super(msg); }
}
