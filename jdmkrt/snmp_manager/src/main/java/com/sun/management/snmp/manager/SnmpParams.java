...
public abstract class SnmpParams implements SnmpDefinitions {
     ...
     * <UL>
     * <LI>{@link com.sun.management.snmp.SnmpDefinitions#snmpVersionOne snmpVersionOne} if the protocol is SNMPv1 
     * <LI>{@link com.sun.management.snmp.SnmpDefinitions#snmpVersionTwo snmpVersionTwo} if the protocol is SNMPv2 
     * <LI>{@link com.sun.management.snmp.SnmpDefinitions#snmpVersionThree snmpVersionThree} if the protocol is SNMPv3 
     * </UL>
     ...
     * <BR>For instance if you wish to use SNMPv2, you can call the method as
     * follows:
     * <BLOCKQUOTE><PRE>
