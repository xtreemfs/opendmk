...
public class SnmpMibOid extends SnmpMibNode implements Serializable {
    private static final long serialVersionUID = -8008057492096412533L;
	...
	if (depth > length) {
	    ...
	    // This behavior should be overriden in subclasses,
	...
	private static final long serialVersionUID = 5100834165085921967L;
