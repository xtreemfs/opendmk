 ...
 * @see com.sun.management.snmp.agent.SnmpMibTable
 *
 *
 * @since Java DMK 5.1
 */
...
// end of NPCTE fix for bugId 4499265
     ...
     * ObjectName policy. This is only meaningful when entries
     ...
     * {@link com.sun.management.snmp.agent.SnmpTableSupport#addEntry(SnmpIndex, ObjectName, Object)} should be preferred.
     ...
     *              {@link com.sun.management.snmp.agent.SnmpTableCallbackHandler}
     *              interface.
     *
