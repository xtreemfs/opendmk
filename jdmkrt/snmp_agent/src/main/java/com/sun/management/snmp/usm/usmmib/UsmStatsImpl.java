...
/**
 * Display the counter of the Usm (RFC 2574).
 *
 * @since Java DMK 5.1
 */
class UsmStatsImpl extends UsmStats {
    ...
    SnmpUsm model = null;
    public UsmStatsImpl(SnmpMib myMib, SnmpUsm model) {
	super(myMib);
	this.model = model;
    }
    /**
	...
	return model.getDecryptionErrorsCounter();
    }
	...
	return model.getWrongDigestsCounter();
    }
	...
	return model.getUnknownEngineIdsCounter();
    }
	...
	return model.getUnknownUserNamesCounter();
    }
	...
	return model.getNotInTimeWindowsCounter();
    }
	...
	return model.getUnsupportedSecLevelsCounter();
    }
