...
public class ASTIdentifier extends SimpleNode {
  ...
  /**
   * Only called when dealing with Index (V1 or V2)
   */
  public void validateIndexNames(IdentifierHandler handler) {
    //Trace.info("\tindex=" + name);
    handler.resolveIdentifier(this);
  }
  ...
  public StringBuffer computeValue(Vector referenceList) throws SemanticException {
    ...
    //
    if (referenceList.contains(resolver)) 
      throw new SemanticException(name);
	
    referenceList.addElement(resolver);
    
    // Trace.info("ID= " + name + " RESOLVER= " + resolver);
    return resolver.computeValue(referenceList);
  }
