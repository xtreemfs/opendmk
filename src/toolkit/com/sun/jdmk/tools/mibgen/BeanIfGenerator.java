...
public abstract class BeanIfGenerator extends Generator implements Serializable {
  
    public BeanIfGenerator(ResourceManager mgr, MibNode node, Context ctxt) 
	throws IOException {
        super(mgr, ctxt);
        this.node = node;
        mib = ctxt.mib;
    ...
    protected static String accessThrows= Def.THROWS + Def.EXCP_SNMP + Def.SEMICOLON;
}
