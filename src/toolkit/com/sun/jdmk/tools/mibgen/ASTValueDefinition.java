...
/* Generated By:JJTree: Do not edit this line. ASTValueDefinition.java */
...
public class ASTValueDefinition extends SimpleNode {
  ASTValueDefinition(int id) {
    super(id);
  }

  ASTValueDefinition(Parser p, int id) {
    super(p, id);
  }

  public static Node jjtCreate(int id) {
      return new ASTValueDefinition(id);
  }

  public static Node jjtCreate(Parser p, int id) {
      return new ASTValueDefinition(p, id);
  }
