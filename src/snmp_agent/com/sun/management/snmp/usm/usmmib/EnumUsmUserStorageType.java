/*
 * @(#)EnumUsmUserStorageType.java	1.11
 *
 * 
 ...
 * @since Java DMK 5.1
 */
public class EnumUsmUserStorageType extends Enumerated implements Serializable {
    private static final long serialVersionUID = 2346808390261791057L;
    ...
    public EnumUsmUserStorageType(int valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumUsmUserStorageType(Integer valueIndex) throws IllegalArgumentException {
        super(valueIndex);
    }

    public EnumUsmUserStorageType() throws IllegalArgumentException {
        super();
    }

    public EnumUsmUserStorageType(String x) throws IllegalArgumentException {
        super(x);
    }
