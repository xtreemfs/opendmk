 ...
 * @since Java DMK 5.1
 */
public class UsmUserMeta extends SnmpMibGroup implements Serializable, SnmpStandardMetaServer {
    private static final long serialVersionUID = -3463851541851633647L;

    /**
     * Constructor for the metadata associated to "UsmUser".
     */
    public UsmUserMeta(SnmpMib myMib, SnmpStandardObjectServer objserv) {
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            ...
            case 1:
                return new SnmpInt(node.getUsmUserSpinLock());
        ...
        switch((int)var) {
            ...
            case 1:
                if (x instanceof SnmpInt) {
                    node.setUsmUserSpinLock(((SnmpInt)x).toInteger());
                    return new SnmpInt(node.getUsmUserSpinLock());
                } else {
    ...
    public void check(SnmpValue x, long var, Object data)
        ...
        switch((int) var) {
            ...
            case 1:
                if (x instanceof SnmpInt) {
                    node.checkUsmUserSpinLock(((SnmpInt)x).toInteger());
                } else {
                    throw new SnmpStatusException(SnmpStatusException.snmpRspWrongType);
                }
                break;
    ...
    public void registerTableNodes(SnmpMib mib, MBeanServer server) {
        tableUsmUserTable = createUsmUserTableMetaNode("UsmUserTable", "UsmUser", mib, server);
        if ( tableUsmUserTable != null)  {
            tableUsmUserTable.registerEntryNode(mib,server);
            mib.registerTableMeta("UsmUserTable", tableUsmUserTable);
        }
     ...
     * 
     * @param tableName Name of the table object ("UsmUserTable")
     * @param groupName Name of the group to which this table belong ("UsmUser")
     * @param mib The SnmpMib object in which this table is registered
     * @param server MBeanServer for this table entries (may be null)
     * 
     * @return An instance of the metadata class generated for the
     *         "UsmUserTable" table (UsmUserTableMeta)
     * 
     **/
    protected UsmUserTableMeta createUsmUserTableMetaNode(String tableName, String groupName, SnmpMib mib, MBeanServer server)  {
        return new UsmUserTableMeta(mib, objectserver);
    }

    protected UsmUserMBean node;
    protected SnmpStandardObjectServer objectserver = null;
    protected UsmUserTableMeta tableUsmUserTable = null;
}
