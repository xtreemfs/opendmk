 ...
 *
 */
/* Generated By:JJTree: Do not edit this line. JDMUser.java */

package com.sun.management.snmp.uacl;

class JDMUser extends User {
    private static final long serialVersionUID = -6549290992760032594L;
    String userName = "";

    public JDMUser(int id) {
    super(id);
    }
    
    public JDMUser(Parser p, int id) {
	super(p, id);
    }
    
    public static Node jjtCreate(int id) {
	return new JDMUser(id);
    }
    
    public static Node jjtCreate(Parser p, int id) {
	return new JDMUser(p, id);
    }
