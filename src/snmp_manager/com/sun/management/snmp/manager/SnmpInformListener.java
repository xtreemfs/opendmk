 ...
 * <P>
 * An <CODE>SnmpInformListener</CODE> will be activated every time
 * the <CODE>SnmpEventReportDispatcher</CODE> receives an inform request.
 *
 * @since Java DMK 5.1
 */
...
public interface SnmpInformListener {
    ...
    /** 
     * Called by <CODE>SnmpEventReportDispatcher</CODE> when an inform request is received.
     *
     * @param anInformPDU The incoming inform PDU.
     */
